                                        ...
                                        <>
                                            ...
                                            {task.subDate < task.dueDate && task.updatedDate === null &&(
                                                <>
                                                    ...
                                                    <p className="text-gray-700 mb-2">
                                                        <strong>Submission Date :</strong> {new Date(task.subDate).toLocaleDateString()}
                                                    </p>
                                            ...
                                            {task.subDate > task.dueDate && task.updatedDate === null &&(
                                                <>
                                                    ...
                                                    <p className="text-gray-700 mb-2">
                                                        <strong>Submission Date :</strong> {new Date(task.lateSubDate).toLocaleDateString()}
                                                    </p>
                                            ...
                                            {task.subDate > task.dueDate && task.updatedDate != null &&(
                                                <>
                                                    ...
                                                    <p className="text-gray-700 mb-2">
                                                        <strong>Submission Date :</strong> {new Date(task.updatedDate).toLocaleDateString()}
                                                    </p>
