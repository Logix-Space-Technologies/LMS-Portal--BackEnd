    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center mt-8 ml-4 mb-4">
                {key === 'lmsapp' ? <h2 className="text-lg font-bold">Admin View Attendance ( Session Name {currentAttendances.length > 0 ? `- ${currentAttendances[0].sessionName}` : ''})</h2> : (key === 'lmsappclgstaff' ? <h2 className="text-lg font-bold">College Staff View Attendance ( Session Name {currentAttendances.length > 0 ? `- ${currentAttendances[0].sessionName}` : ''})</h2> : <h2 className="text-lg font-bold">Admin Staff View Attendance ( Session Name {currentAttendances.length > 0 ? `- ${currentAttendances[0].sessionName}` : ''})</h2>)}
