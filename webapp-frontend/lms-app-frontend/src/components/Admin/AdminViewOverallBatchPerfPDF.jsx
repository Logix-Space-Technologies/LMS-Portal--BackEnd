...
const AdminViewOverallBatchPerfPDF = () => {
    ...
    const apiUrl = global.config.urls.api.server + "/api/lms/ViewBatchWisePerformancePDF"

    const batchId = sessionStorage.getItem("viewBatchScoreBatchId");
    ...
    const generatePDF = async () => {
        ...
        const opt = {
            margin: 0.4,
            filename: 'batch_wise_score_list.pdf',
        ...
        html2pdf().set(opt).from(element).toPdf().get('pdf').then(function (pdf) {
            ...
            pdf.save('batch_wise_score_list.pdf');
        });
    };
                            ...
                            <div className="bg-white p-4 p-md-5 rounded shadow-sm">
                                <div className="row gy-3 gy-md-4 overflow-hidden">
                                    <div className="flex justify-between items-center mx-4 my-4">
                                        ...
                                        <strong style={{ textAlign: "center", fontSize: "24px" }}>Download Preview Of Batch-Wise Score List</strong>
                                        <div>
...
export default AdminViewOverallBatchPerfPDF