                                ...
                                currentLogs.map((value, index) => {
                                    return (
                                        <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td className="px-6 py-4">{value.sentDate}</td>
                                            <td className="px-6 py-4">{value.deliveryStatus}</td>
                                            <td className="px-6 py-4">{value.deliveryDate}</td>
                                            <td className="px-6 py-4">{value.readStatus}</td>
                                            <td className="px-6 py-4">{value.readDateTime}</td>
                                        </tr>
                                    );
                                })
                            ) : (
...
export default AdminViewWhatsappFeedback