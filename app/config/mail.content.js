...
function reschedulingSessionTrainerHTMLContent(originaldate, sessionDate, sessionTime, type, venueORlink, batchName, collegeName, trainerName, isVenueOrLinkChangedOnly, isTimeChangeOnly) {
  // Get the current year
  const currentYear = new Date().getFullYear();
  let content = `
  <!DOCTYPE html>
...
function reschedulingSessionTrainerTextContent(originaldate, sessionDate, sessionTime, type, venueORlink, batchName, collegeName, trainerName, isVenueOrLinkChangedOnly, isTimeChangeOnly) {
  // Get the current year
  const currentYear = new Date().getFullYear();
  let content = `Dear ${trainerName},\n\n`;
  ...
  content += `Time: ${sessionTime}\n`;
  content += `College Name: ${collegeName}\n`;
  content += `Batch Name: ${batchName}\n`;
  content += `Session Type: ${type}\n`;
  content += `Venue: ${venueORlink}\n\n`;
    ...
    <body>
      <div class="container">
        ...
        <p>We acknowledge the receipt of your email dated ${requestedDate}, regarding your decision to withdraw from the "Link Ur Codes"
          ...
          you can expect the amount to be credited within 65 to 75 WORKING Days.</p>
...
function refundRequestConfirmationTextContent(studName, requestedDate, addedDate, remainingPaymentPeriod) {
  ...
  We acknowledge the receipt of your email dated ${requestedDate}, regarding your decision to withdraw from the "Link Ur Codes" skill development program. As per the details you provided, you joined the program on ${addedDate}, and based on your withdrawal date, there are ${remainingPaymentPeriod} days remaining in your subscription period. In line with our commitment at the time of registration, we will calculate the refund on a pro-rata basis. Please be assured that the amount will be refunded to the bank account details you have provided. The process will be initiated, and you can expect the amount to be credited within 65 to 75 WORKING Days.
  ...
  <body>
    <div class="container">
      ...
      <p>We hope this message finds you well. We are writing to inform you that the refund amount of INR ${approvedamnt},
        ...
        be credited in your
        bank account within the next 65 to 75 WORKING DAYS.</p>
...
module.exports = {
  ...
  reschedulingSessionTrainerHTMLContent,
  ...
  reschedulingSessionTrainerTextContent,
