                                ...
                                {loading ? <div className="col-12 text-center">Loading...</div> : <table className="w-full table-auto">
                                    ...
                                    <tbody>
                                        {currentTasks.length > 0 ? currentTasks.map(
                                            ...
                                            <tr>
                                                <td colSpan="9" className="text-dark border-b border-l border-[#E8E8E8] bg-[#F3F6FF] dark:bg-dark-3 dark:border-dark dark:text-dark-7 py-5 px-2 text-center text-base font-medium">
                                                    No Tasks Found !!!
                                                </td>
                                            </tr>
                                        )}
