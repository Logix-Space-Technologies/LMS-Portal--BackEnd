...
const CollegeStaffViewNotifications = () => {
    ...
    const fetchNotifications = () => {
        const apiUrl = global.config.urls.api.server + "/api/lms/clgstaffviewnotification";
        const batchId = sessionStorage.getItem("clgstaffbatchId");
...
export default CollegeStaffViewNotifications